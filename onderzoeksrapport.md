...
**<img src="images/microbit_front_2.jpg" alt="drawing" width="33%; display:block"/>De micro:bit bevat 3 knopjes: 2 die aanspreekbaar zijn in de code (A en B), en achteraan een reset button.**
**<img src="images/microbit_connectors.jpg" alt="drawing" width="33%; display:block"/>De micro:bit bevat 3 knopjes: 2 die aanspreekbaar zijn in de code (A en B), en achteraan een reset button.**
